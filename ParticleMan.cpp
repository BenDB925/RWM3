...
ParticleMan::ParticleMan(ParticleSettings pSettings)
...
void ParticleMan::update(float pDT)
{
...
void ParticleMan::render(SDL_Renderer * pRenderer)
{
	for (int i = 0; i < _particleList.size(); i++)
	{
...
void ParticleMan::SpawnParticle(Vector2 pDir)
{
